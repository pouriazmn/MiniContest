# Generated by Django 2.2.3 on 2019-08-22 22:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('P', 'Problem'), ('D', 'Duel')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='SolvingAttempt',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('1', 'Type1 8%'), ('2', 'Type2 12%'), ('3', 'Type3 16%')], max_length=1)),
